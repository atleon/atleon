...
public final class AvroRegistrySerializerConfig extends RegistrySerializerConfig {
    ...
    public static ConfigDef avroRegistrySerializerConfigDef() {
        return registrySerializerConfigDef()
                ...
                .define(
                        SCHEMA_CACHING_ENABLED_CONFIG,
                        ConfigDef.Type.BOOLEAN,
                        SCHEMA_CACHING_ENABLED_DEFAULT,
                        ConfigDef.Importance.MEDIUM,
                        SCHEMA_CACHING_ENABLED_DOC)
                .define(
                        SCHEMA_GENERATION_ENABLED_CONFIG,
                        ConfigDef.Type.BOOLEAN,
                        SCHEMA_GENERATION_ENABLED_DEFAULT,
                        ConfigDef.Importance.MEDIUM,
                        SCHEMA_GENERATION_ENABLED_DOC);
    }
