...
/**
 * Convenient (i.e. non-generic) interface for reactive Kafka polled observation conventions
 */
public interface KafkaPolledObservationConvention extends ObservationConvention<KafkaConsumeContext> {
    ...
    class Default implements KafkaPolledObservationConvention {
        ...
        public KeyValues getLowCardinalityKeyValues(KafkaConsumeContext context) {
            ...
            keyValues.add(LowCardinalityTags.MESSAGING_OPERATION_NAME.withValue("polled"));
            keyValues.add(LowCardinalityTags.MESSAGING_OPERATION_TYPE.withValue("receive"));
