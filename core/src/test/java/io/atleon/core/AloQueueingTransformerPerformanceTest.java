...
public class AloQueueingTransformerPerformanceTest {
    ...
    public void processingItemsWithProbabilisticDelayCompletesInReasonableTime(AcknowledgementQueueMode queueMode) {
        ...
        AloComponentExtractor<Integer, Integer> componentExtractor =
                AloComponentExtractor.composed(value -> () -> {}, value -> error -> {}, Function.identity());
        ...
        System.out.printf(
                ...
                count, queueMode, System.currentTimeMillis() - startEpochMillis);
    }
