...
public final class KafkaReceiverOptions<K, V> {
    ...
    private KafkaReceiverOptions(
        ...
        Duration processingGracePeriod,
    ...
    /**
     * @see Builder#processingGracePeriod(Duration)
     */
    public Duration processingGracePeriod() {
        return processingGracePeriod;
    }
    ...
    public static final class Builder<K, V> {
        ...
        private Duration processingGracePeriod = DEFAULT_PROCESSING_GRACE_PERIOD;
         ...
         * acknowledged from an assigned partition that is no longer being actively consumed, i.e.
         * due to revocation. The latest acknowledged offsets from such a partition are then used
         * to issue one last commit before processing/rebalancing is allowed to continue. Note that
         * if it is intended for record acknowledgements to be skipped, this should be set to
         * {@link Duration#ZERO zero} such that consumption continuation does not wait on
         * acknowledgement(s) that will never happen.
         */
        public Builder<K, V> processingGracePeriod(Duration processingGracePeriod) {
            this.processingGracePeriod = processingGracePeriod;
            return this;
        }
