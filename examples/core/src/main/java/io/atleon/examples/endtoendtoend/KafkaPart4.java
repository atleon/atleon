...
public class KafkaPart4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AloKafkaReceiver<Object, String> kafkaValueFluxFactory = AloKafkaReceiver.forValues(kafkaPublisherConfig);
        ...
        kafkaValueFluxFactory
            .receiveAloValues(Collections.singletonList(TOPIC_2))
            .unwrap()
            .doOnNext(Alo::acknowledge)
            .map(Alo::get)
            .take(1)
