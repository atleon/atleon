...
public class KafkaToRabbitMQ {
    ...
    public static void main(String[] args) throws Exception {
        ...
        kafkaSender.sendValues(Flux.just("Test"), value -> TOPIC, Function.identity())
            .collectList()
        ...
        AloKafkaReceiver.<Object, String>create(kafkaReceiverConfig)
            ...
            .transform(rabbitMQSender.sendAloBodies(DefaultRabbitMQMessageCreator.minimalBasicToDefaultExchange(QUEUE)))
