...
abstract class ReactiveConnection implements ShutdownListener {
    ...
    @Override
    public final void shutdownCompleted(ShutdownSignalException cause) {
        closed.tryEmitError(cause);
    }
