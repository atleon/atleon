...
public final class RabbitMQReceiverOptions {
    ...
    private RabbitMQReceiverOptions(
            IOSupplier<Connection> connectionSupplier, String consumerTag, int prefetch, Duration closeTimeout) {
    ...
    public static final class Builder {
        ...
        public RabbitMQReceiverOptions build() {
            ...
            return new RabbitMQReceiverOptions(connectionSupplier::getConnection, consumerTag, prefetch, closeTimeout);
        }
    }
}
