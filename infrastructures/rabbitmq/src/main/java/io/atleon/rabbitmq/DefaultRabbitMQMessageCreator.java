...
public final class DefaultRabbitMQMessageCreator<T> extends AbstractRabbitMQMessageCreator<T> {
    ...
    public static <T> DefaultRabbitMQMessageCreator<T> minimalBasicToDefaultExchange(
            Function<? super T, String> queueExtractor) {
    ...
    public static <T> DefaultRabbitMQMessageCreator<T> minimalBasic(
            String exchange, Function<? super T, String> routingKeyExtractor) {
        return new DefaultRabbitMQMessageCreator<>(MessageProperties.MINIMAL_BASIC, t -> exchange, routingKeyExtractor);
    }

    public static <T> DefaultRabbitMQMessageCreator<T> toDefaultExchange(
            AMQP.BasicProperties properties, String queue) {
        return new DefaultRabbitMQMessageCreator<>(properties, t -> "", t -> queue);
    }

    public static <T> DefaultRabbitMQMessageCreator<T> toDefaultExchange(
            AMQP.BasicProperties properties, Function<? super T, String> queueExtractor) {
        return new DefaultRabbitMQMessageCreator<>(properties, t -> "", queueExtractor);
    }

    public static <T> DefaultRabbitMQMessageCreator<T> of(
            AMQP.BasicProperties properties, String exchange, String routingKey) {
        return new DefaultRabbitMQMessageCreator<>(properties, t -> exchange, t -> routingKey);
    }

    public static <T> DefaultRabbitMQMessageCreator<T> of(
            AMQP.BasicProperties properties, String exchange, Function<? super T, String> routingKeyExtractor) {
