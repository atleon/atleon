...
class SpringAloStreamTest {
    ...
    @Test
    public void getProperty_givenAvailableAndDefaultProperties_expectsReturnedValues() {
        ...
        assertEquals(4, stream.concurrency());
        assertEquals(1, stream.batchSize());
        assertEquals(Duration.ofSeconds(5), stream.batchDuration());
    }
